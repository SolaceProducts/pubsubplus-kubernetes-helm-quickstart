...
sed -i 's/description:.*$/description: Deploy a minimum footprint single-node non-HA Solace PubSub+ software event broker onto a Kubernetes Cluster for development purposes/g' pubsubplus-dev/Chart.yaml
