...
sed -i 's@charts.openshift.io/name@charts.openshift.io/name: PubSub+ Event Broker, HA@g' pubsubplus-ha/Chart.yaml
...
sed -i 's@charts.openshift.io/name@charts.openshift.io/name: PubSub+ Event Broker for Developers@g' pubsubplus-dev/Chart.yaml
...
sed -i 's@charts.openshift.io/name@charts.openshift.io/name: PubSub+ Event Broker, non-HA@g' pubsubplus/Chart.yaml
