...
```sh
git clone https://github.com/<my-github-org>/<my-github-repo>
```
...
```sh
$ git remote add upstream https://github.com/SolaceProducts/<current-github-repo>
```
...
* Open a GitHub [enhancement request issue](/issues/new) and describe the new functionality.
