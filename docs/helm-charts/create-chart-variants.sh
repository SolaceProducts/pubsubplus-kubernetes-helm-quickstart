...
sed -i '/charts.openshift.io\/name:/ s@charts.openshift.io/name.*@charts.openshift.io/name: Solace Event Broker, HA@g' pubsubplus-ha/Chart.yaml
...
sed -i '/charts.openshift.io\/name:/ s@charts.openshift.io/name.*@charts.openshift.io/name: Solace Event Broker for Developers@g' pubsubplus-dev/Chart.yaml
...
sed -i '/charts.openshift.io\/name:/ s@charts.openshift.io/name.*@charts.openshift.io/name: Solace Event Broker, non-HA@g' pubsubplus/Chart.yaml
